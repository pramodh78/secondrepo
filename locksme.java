package packagemypackage1;
import java.io.File;
import java.io.IOException;
import java.util.Arrays;
import java.util.Scanner;

public class locksme {
    ...
    void showSecondaryMenu() {
        ...
        try{
            ...
            switch (option){
                case 'a' : {
                    System.out.print("↳ Adding a file...chikki : ");
                    String filename = scanner.next().trim().toLowerCase();
                    addFile(filename);
                    break;
                }
                case 'b' : {
                    System.out.print("↳ Deleting a file...chikki : ");
                    String filename = scanner.next().trim();
                    deleteFile(filename);
                    break;
                }
                case 'c' : {
                    System.out.print("↳ Searching a file...chikki : ");
                    String filename = scanner.next().trim();
                    searchFile(filename);
                    break;
                }
